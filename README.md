...
```bash
pip install https://github.com/kfrlib/cxxdox/releases/download/v0.1.0/mkdocs_cxxdox-0.1.0-win_amd64.whl
```
...
```bash
pip install mkdocs_cxxdox-0.1.0-cp312-none-win_amd64.whl
```
...
pip install mkdocs_cxxdox-0.1.0-win_amd64.whl "mkdocs-material>=9.1.15"
```
